...
public class KBPStatisticalExtractor implements IntelKBPRelationExtractor, Serializable {
    ...
    protected static final Redwood.RedwoodChannels log = Redwood.channels(KBPStatisticalExtractor.class);

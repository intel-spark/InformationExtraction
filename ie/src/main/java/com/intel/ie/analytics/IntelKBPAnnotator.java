...
public class IntelKBPAnnotator implements Annotator {
     ...
     */
    public final IntelKBPRelationExtractor extractor;
    ...
    protected void acronymMatch(List<CoreMap> mentions, Map<CoreMap, Set<CoreMap>> mentionsMap) {
        ...
        for (CoreMap mention : mentions) {
            ...
            if (nerTag != null && (nerTag.equals(IntelKBPRelationExtractor.NERTag.ORGANIZATION.name)
                    || nerTag.equals(IntelKBPRelationExtractor.NERTag.LOCATION.name))) {
                ...
                if (subjNER.isPresent()
                    ...
                    for (int objI = 0; objI < candidates.size(); ++objI) {
                        ...
                        if (objNER.isPresent()
                            ...
                            if (!IntelKBPStatisticalExtractor.NO_RELATION.equals(prediction.first)) {

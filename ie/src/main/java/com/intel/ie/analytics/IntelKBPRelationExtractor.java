...
import static com.intel.ie.analytics.IntelKBPRelationExtractor.NERTag.*;
...
//        PER_RELIGION("per:religion", true, 3, PERSON, Cardinality.SINGLE, new NERTag[]{RELIGION}, new String[]{"NN"}, 7.6650738739572610E-4),
        PER_FORMER_TITLE("per:former_title", true, 15, PERSON, Cardinality.LIST, new NERTag[]{TITLE, MODIFIER}, new String[]{"NN"}, 0.0334283995325751200),

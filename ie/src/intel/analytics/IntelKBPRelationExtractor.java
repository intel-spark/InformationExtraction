...
import static intel.analytics.IntelKBPRelationExtractor.NERTag.*;
 ...
 * @author Gabor Angeli
 */
public interface IntelKBPRelationExtractor {
    ...
    enum NERTag {
        ...
        DEPARTMENT("DEPARTMENT", "DEP", false),
...
//  SCHOOL            ("SCHOOL",            "SCH", true),
    ...
    enum RelationType {
        ...
        PER_EMPLOYEE_OF_DEP("per:employee_of_dep", true, 10, PERSON, Cardinality.LIST, new NERTag[]{DEPARTMENT, COUNTRY, STATE_OR_PROVINCE, CITY}, new String[]{"NNP"}, 2.0335281901169719200),
        ...
        ORG_TOP_MEMBERS_SLASH_EMPLOYEES_DEP("org:top_members/employees_dep", true, 10, DEPARTMENT, Cardinality.LIST, new NERTag[]{PERSON}, new String[]{"NNP"}, 0.0907168724184609800),

 ...
 * @author Gabor Angeli
 */
public class KBPTokensregexExtractor implements edu.stanford.nlp.ie.KBPRelationExtractor {
  protected static final Redwood.RedwoodChannels logger = Redwood.channels(edu.stanford.nlp.ie.KBPTokensregexExtractor.class);

 ...
 * @author Gabor Angeli
 */
public class KBPSemgrexExtractor implements edu.stanford.nlp.ie.KBPRelationExtractor {
  protected final Redwood.RedwoodChannels logger = Redwood.channels(edu.stanford.nlp.ie.KBPSemgrexExtractor.class);
